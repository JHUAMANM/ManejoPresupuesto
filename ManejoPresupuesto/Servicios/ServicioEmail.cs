...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class ServicioEmail : IServicioEmail
    {
        ...
        public async Task EnviarEmailCambioPassword(string receptor, string enlace)
        {
            ...
            var contenidoHTML = $@"Saludos, este mensaje le llega porque usted ha solicitado un cambio de contraseña.
                                 Si esta solicitus no fue hecha por usted, puede ignorar este mensaje.
                                 Para cambiar su contraseña, haga click ene le siguiente enlace:
                                 {enlace}
                                 Atentamente:
