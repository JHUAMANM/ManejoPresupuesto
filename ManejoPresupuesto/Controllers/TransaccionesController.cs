...
namespace ManejoPresupuesto.Controllers
{
    ...
    public class TransaccionesController : Controller
    {
        ...
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            IEnumerable<ResultadoObtenerPorSemana> transacionesPorSemana = await servicioReportes.ObtenerReporteSemanal(usuarioId, mes, año, ViewBag);

            var agrupado = transacionesPorSemana.GroupBy(x => x.Semana).Select(x => new ResultadoObtenerPorSemana()
            {
                Semana = x.Key,
        ...
        public async Task<IActionResult> Editar(TransaccionActualizacionViewModel modelo)
        {
            ...
            //Para que retorne a la misma vista de detalle al momento de editar la transacción
        ...
        public async Task<IActionResult> Borrar(int id, string urlRetorno = null)
        {
            ...
            //Para que retorne a la misma vista de detalle al momento de borrar la transacción
        ...
        //Se agrega  --Seleccione una categoría--
